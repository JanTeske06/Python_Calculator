...
<p align="center">
  <img src="Screenshots/Main_window.png" width="400" alt="Advanced Python Calculator Main Window">
</p>
...
|------------|-------------|-----------|
| ![](Screenshots/Main_window.png) | ![](Screenshots/Main_Window_White_Mode.png) | ![](Screenshots/Settings_Example.png) |

| Calculation Example | Fraction Display | Solver Example |
|----------------------|------------------|----------------|
| ![](Screenshots/Calculation_Example.png) | ![](Screenshots/Calculation_Example_Fractions.png) | ![](Screenshots/Solver_Example.png) |

| Error Dialog |
|---------------|
| ![](Screenshots/Error_Example.png) |
...
* **Utilities:** `pyperclip` (cross-platform clipboard), `pynput` (key listener for modifiers like Shift)  
* **Configuration:** `json`
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/JanTeske06/Python_Calculator.git
