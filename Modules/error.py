...
class CalculationError(MathError):
    """Numeric/runtime calculation issues (e.g., division by zero)."""
    pass


class SolverError(MathError):
    """Algebraic solver issues (e.g., non-linear, multiple variables)."""
    pass
...
#   (e.g., operator/problem string). Keep the base text short and neutral.
